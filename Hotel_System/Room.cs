...
namespace Hotel_System
{
    class Room
    {
        ...
        public DataTable GetRoomTypePrice(int type)
        {
            MySqlCommand command = new MySqlCommand("SELECT price FROM rooms_type WHERE id=@type", conn.GetConnection());
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            DataTable table = new DataTable();
        ...
        public DataTable SearchRoom(int roomNumber)
        {
            MySqlCommand command = new MySqlCommand();
            string querySearch = "SELECT * FROM rooms WHERE number LIKE @number";
